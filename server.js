...
/* ------------------------------------------------------------------ static */
const WEB_BUILD = 38; // bump when frontend changes; index.html asset URLs get ?v=<WEB_BUILD> auto-injected
const MIME = {
...
const APP_VERSION = 38; // keep in sync with public/latest.json
...
server.listen(PORT, HOST, () => {
  console.log('');
  console.log('  ✦✦✦  frfr build v3.8  ✦✦✦');
  console.log('  if u see this line, the NEWEST code is running (web badge: v3.8)');
